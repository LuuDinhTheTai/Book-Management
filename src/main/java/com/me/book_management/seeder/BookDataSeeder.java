...
public class BookDataSeeder implements CommandLineRunner {
        ...
        if (detailRepository.count() == 0) {
            ...
            List<Detail> details = List.of(
                ...
                createDetail("978-0596007126", "Head First Java", "Your Brain on Java", 
                    ...
                    "720", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0132778046", "Core Java Volume I", "Fundamentals", 
                    ...
                    "1008", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-1617292545", "Spring in Action", "Covers Spring 4", 
                    ...
                    "624", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-1491950357", "Programming Hive", "Data Warehouse and Query Language for Hadoop", 
                    ...
                    "350", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-1449355739", "Learning Python", "Powerful Object-Oriented Programming", 
                    ...
                    "1600", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0596517748", "JavaScript: The Good Parts", "Unearthing the Excellence in JavaScript", 
                    ...
                    "176", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0134757599", "Clean Architecture", "A Craftsman's Guide to Software Structure and Design", 
                    ...
                    "432", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0201634983", "Extreme Programming Explained", "Embrace Change", 
                    ...
                    "224", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0201633610", "Patterns of Enterprise Application Architecture", "Enterprise Application Architecture Patterns", 
                    ...
                    "560", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0201633610", "Test Driven Development", "By Example", 
                    ...
                    "240", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0201633610", "Continuous Integration", "Improving Software Quality and Reducing Risk", 
                    ...
                    "288", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0137081073", "Continuous Delivery", "Reliable Software Releases through Build, Test, and Deployment Automation", 
                    ...
                    "512", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0201634983", "The DevOps Handbook", "How to Create World-Class Agility, Reliability, and Security in Technology Organizations", 
                    ...
                    "480", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0137081073", "The Goal", "A Process of Ongoing Improvement", 
                    ...
                    "384", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0135974445", "The Lean Startup", "How Today's Entrepreneurs Use Continuous Innovation to Create Radically Successful Businesses", 
                    ...
                    "336", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0201633610", "The Art of Computer Programming", "Volume 1: Fundamental Algorithms", 
                    ...
                    "672", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0132350884", "Structure and Interpretation of Computer Programs", "SICP", 
                    ...
                    "657", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0201634983", "Code Complete", "A Practical Handbook of Software Construction", 
                    ...
                    "960", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0135974445", "Designing Data-Intensive Applications", "The Big Ideas Behind Reliable, Scalable, and Maintainable Systems", 
                    ...
                    "616", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0132350884", "High Performance MySQL", "Optimization, Backups, and Replication", 
                    ...
                    "828", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0201634983", "Redis in Action", "Real-time Data with Redis", 
                    ...
                    "400", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0137081073", "MongoDB in Action", "Covers MongoDB version 3.0", 
                    ...
                    "496", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0135974445", "Elasticsearch: The Definitive Guide", "A Distributed Real-Time Search and Analytics Engine", 
                    ...
                    "724", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0201633610", "Kafka: The Definitive Guide", "Real-Time Data and Stream Processing at Scale", 
                    ...
                    "322", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0135974445", "Ansible: Up and Running", "Automating Configuration Management and Deployment the Easy Way", 
                    ...
                    "398", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0201633610", "The Linux Programming Interface", "A Linux and UNIX System Programming Handbook", 
                    ...
                    "1552", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0132350884", "Advanced Programming in the UNIX Environment", "APUE", 
                    ...
                    "1024", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0201634983", "Computer Networks", "A Systems Approach", 
                    ...
                    "920", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0137081073", "Computer Organization and Design", "The Hardware/Software Interface", 
                    ...
                    "800", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0135974445", "Operating System Concepts", "Abraham Silberschatz, Peter B. Galvin, Greg Gagne", 
                    ...
                    "1040", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK),
                ...
                createDetail("978-0201633610", "Modern Operating Systems", "Andrew S. Tanenbaum, Herbert Bos", 
                    ...
                    "1136", Constants.BOOK_LANGUAGE.EN, Constants.BOOK_FORMAT.EBOOK)
            );
        ...
        if (bookRepository.count() == 0) {
            ...
            if (!details.isEmpty() && !accounts.isEmpty()) {
                ...
                List<Book> books = List.of(
                    ...
                    createBook("Design Patterns", 52.50f, 8, Constants.BOOK_STATUS.AVAILABLE, details.get(1), defaultAccount),
                    createBook("Effective Java", 39.99f, 15, Constants.BOOK_STATUS.AVAILABLE, details.get(2), defaultAccount),
                    createBook("Head First Java", 34.99f, 12, Constants.BOOK_STATUS.AVAILABLE, details.get(3), defaultAccount),
                    createBook("Core Java Volume I", 49.99f, 6, Constants.BOOK_STATUS.AVAILABLE, details.get(4), defaultAccount),
                    createBook("Spring in Action", 44.99f, 9, Constants.BOOK_STATUS.AVAILABLE, details.get(5), defaultAccount),
                    createBook("Programming Hive", 29.99f, 5, Constants.BOOK_STATUS.AVAILABLE, details.get(6), defaultAccount),
                    createBook("Learning Python", 59.99f, 7, Constants.BOOK_STATUS.AVAILABLE, details.get(7), defaultAccount),
                    createBook("JavaScript: The Good Parts", 24.99f, 11, Constants.BOOK_STATUS.AVAILABLE, details.get(8), defaultAccount),
                    createBook("Introduction to Algorithms", 89.99f, 4, Constants.BOOK_STATUS.AVAILABLE, details.get(9), defaultAccount),
                    createBook("The C Programming Language", 35.99f, 8, Constants.BOOK_STATUS.AVAILABLE, details.get(10), defaultAccount),
                    createBook("Refactoring", 42.50f, 6, Constants.BOOK_STATUS.AVAILABLE, details.get(11), defaultAccount),
                    createBook("Clean Architecture", 48.99f, 9, Constants.BOOK_STATUS.AVAILABLE, details.get(12), defaultAccount),
                    createBook("The Clean Coder", 38.99f, 7, Constants.BOOK_STATUS.AVAILABLE, details.get(13), defaultAccount),
                    createBook("Extreme Programming Explained", 32.99f, 5, Constants.BOOK_STATUS.AVAILABLE, details.get(14), defaultAccount),
                    createBook("Agile Software Development", 55.99f, 4, Constants.BOOK_STATUS.AVAILABLE, details.get(15), defaultAccount),
                    createBook("Patterns of Enterprise Application Architecture", 65.99f, 3, Constants.BOOK_STATUS.AVAILABLE, details.get(16), defaultAccount),
                    createBook("Domain-Driven Design", 58.99f, 6, Constants.BOOK_STATUS.AVAILABLE, details.get(17), defaultAccount),
                    createBook("Test Driven Development", 36.99f, 8, Constants.BOOK_STATUS.AVAILABLE, details.get(18), defaultAccount),
                    createBook("Working Effectively with Legacy Code", 44.99f, 5, Constants.BOOK_STATUS.AVAILABLE, details.get(19), defaultAccount),
                    createBook("Continuous Integration", 39.99f, 7, Constants.BOOK_STATUS.AVAILABLE, details.get(20), defaultAccount),
                    createBook("Continuous Delivery", 52.99f, 4, Constants.BOOK_STATUS.AVAILABLE, details.get(21), defaultAccount),
                    createBook("The DevOps Handbook", 69.99f, 3, Constants.BOOK_STATUS.AVAILABLE, details.get(22), defaultAccount),
                    createBook("Site Reliability Engineering", 74.99f, 2, Constants.BOOK_STATUS.AVAILABLE, details.get(23), defaultAccount),
                    createBook("The Phoenix Project", 42.99f, 6, Constants.BOOK_STATUS.AVAILABLE, details.get(24), defaultAccount),
                    createBook("The Unicorn Project", 49.99f, 4, Constants.BOOK_STATUS.AVAILABLE, details.get(25), defaultAccount),
                    createBook("Accelerate", 54.99f, 5, Constants.BOOK_STATUS.AVAILABLE, details.get(26), defaultAccount),
                    createBook("The Goal", 29.99f, 9, Constants.BOOK_STATUS.AVAILABLE, details.get(27), defaultAccount),
                    createBook("The Lean Startup", 34.99f, 8, Constants.BOOK_STATUS.AVAILABLE, details.get(28), defaultAccount),
                    createBook("The Art of Computer Programming", 99.99f, 2, Constants.BOOK_STATUS.AVAILABLE, details.get(29), defaultAccount),
                    createBook("Structure and Interpretation of Computer Programs", 79.99f, 3, Constants.BOOK_STATUS.AVAILABLE, details.get(30), defaultAccount),
                    createBook("Code Complete", 69.99f, 4, Constants.BOOK_STATUS.AVAILABLE, details.get(31), defaultAccount),
                    createBook("The Pragmatic Programmer", 44.99f, 7, Constants.BOOK_STATUS.AVAILABLE, details.get(32), defaultAccount),
                    createBook("Designing Data-Intensive Applications", 64.99f, 5, Constants.BOOK_STATUS.AVAILABLE, details.get(33), defaultAccount),
                    createBook("Database Design for Mere Mortals", 49.99f, 6, Constants.BOOK_STATUS.AVAILABLE, details.get(34), defaultAccount),
                    createBook("High Performance MySQL", 59.99f, 4, Constants.BOOK_STATUS.AVAILABLE, details.get(35), defaultAccount),
                    createBook("Redis in Action", 39.99f, 8, Constants.BOOK_STATUS.AVAILABLE, details.get(36), defaultAccount),
                    createBook("MongoDB in Action", 44.99f, 6, Constants.BOOK_STATUS.AVAILABLE, details.get(37), defaultAccount),
                    createBook("Elasticsearch: The Definitive Guide", 54.99f, 3, Constants.BOOK_STATUS.AVAILABLE, details.get(38), defaultAccount),
                    createBook("Kafka: The Definitive Guide", 49.99f, 5, Constants.BOOK_STATUS.AVAILABLE, details.get(39), defaultAccount),
                    createBook("Docker in Action", 42.99f, 7, Constants.BOOK_STATUS.AVAILABLE, details.get(40), defaultAccount),
                    createBook("Kubernetes in Action", 64.99f, 4, Constants.BOOK_STATUS.AVAILABLE, details.get(41), defaultAccount),
                    createBook("Terraform: Up & Running", 39.99f, 6, Constants.BOOK_STATUS.AVAILABLE, details.get(42), defaultAccount),
                    createBook("Ansible: Up and Running", 36.99f, 8, Constants.BOOK_STATUS.AVAILABLE, details.get(43), defaultAccount),
                    createBook("The Linux Programming Interface", 89.99f, 2, Constants.BOOK_STATUS.AVAILABLE, details.get(44), defaultAccount),
                    createBook("Advanced Programming in the UNIX Environment", 74.99f, 3, Constants.BOOK_STATUS.AVAILABLE, details.get(45), defaultAccount),
                    createBook("Computer Networks", 69.99f, 4, Constants.BOOK_STATUS.AVAILABLE, details.get(46), defaultAccount),
                    createBook("Computer Organization and Design", 79.99f, 3, Constants.BOOK_STATUS.AVAILABLE, details.get(47), defaultAccount),
                    createBook("Operating System Concepts", 84.99f, 2, Constants.BOOK_STATUS.AVAILABLE, details.get(48), defaultAccount),
                    createBook("Modern Operating Systems", 89.99f, 2, Constants.BOOK_STATUS.AVAILABLE, details.get(49), defaultAccount)
                );
    ...
    private Category getCategoryForBook(int bookIndex, List<Category> categories) {
        // Map books to categories based on their content
        String[] categoryNames = {
            "Software Engineering", "Software Engineering", "Programming", "Programming", "Programming",
            "Web Development", "Database", "Programming", "Programming", "Computer Science",
            "Programming", "Software Engineering", "Software Engineering", "Software Engineering", "Software Engineering",
            ...
            "DevOps", "DevOps", "Business & Management", "Business & Management", "Computer Science",
            "Computer Science", "Software Engineering", "Software Engineering", "Database", "Database",
            "Database", "Database", "Database", "Database", "Database",
            "Cloud Computing", "Cloud Computing", "Cloud Computing", "Cloud Computing", "System Administration",
            "System Administration", "Networking", "Operating Systems", "Operating Systems", "Operating Systems"
        };
        
        if (bookIndex < categoryNames.length) {
            String categoryName = categoryNames[bookIndex];
        ...
        return categories.get(0); // Default fallback
    }
